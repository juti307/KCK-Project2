...
namespace MiniLibrary2 {
    ...
    public partial class BooksDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(string Name, string Author, string Genre, System.DateTime Date) {
            ...
            public string Name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'Name\' w tabeli \'Books\' to DBNull.", e);
                    }
                }
                set {
            ...
            public string Genre {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'Genre\' w tabeli \'Books\' to DBNull.", e);
                    }
                }
                set {
            ...
            public System.DateTime Date {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'Date\' w tabeli \'Books\' to DBNull.", e);
                    }
                }
                set {
...
namespace MiniLibrary2.BooksDBDataSet1TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([BookId] = @Original_BookId) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Genre = 1 AND [Genre] IS NULL) OR ([Genre] = @Original_Genre)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Name], [Author], [Genre], [Date]) VALUES (@Name, @Aut" +
                "hor, @Genre, @Date);\r\nSELECT BookId, Name, Author, Genre, Date FROM Books WHERE " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Name] = @Name, [Author] = @Author, [Genre] = @Genre, [Date] = @Date WHERE (([BookId] = @Original_BookId) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Genre = 1 AND [Genre] IS NULL) OR ([Genre] = @Original_Genre)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));
SELECT BookId, Name, Author, Genre, Date FROM Books WHERE (BookId = @BookId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MiniLibrary2.Properties.Settings.Default.BooksDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookId, Name, Author, Genre, Date FROM dbo.Books";
        ...
        public virtual int Delete(int Original_BookId, string Original_Name, string Original_Author, string Original_Genre, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(string Name, string Author, string Genre, global::System.Nullable<global::System.DateTime> Date) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Author, string Genre, global::System.Nullable<global::System.DateTime> Date, int Original_BookId, string Original_Name, string Original_Author, string Original_Genre, global::System.Nullable<global::System.DateTime> Original_Date, int BookId) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Author, string Genre, global::System.Nullable<global::System.DateTime> Date, int Original_BookId, string Original_Name, string Original_Author, string Original_Genre, global::System.Nullable<global::System.DateTime> Original_Date) {
            return this.Update(Name, Author, Genre, Date, Original_BookId, Original_Name, Original_Author, Original_Genre, Original_Date, Original_BookId);
        }
    }
